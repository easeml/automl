...
//var easemlSchema = require("./src/index").default;
import easemlSchema from "./src/index";

console.log(easemlSchema);

let ReaderWriterCloser = easemlSchema.dataset.ReaderWriterCloser;
